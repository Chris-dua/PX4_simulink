    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (px4_noGPS3_P)
        ;%
            section.nData     = 10;
            section.data(10)  = dumData; %prealloc

                    ;% px4_noGPS3_P.DiscreteDerivative_ICPrevScaled
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_P.DiscreteDerivative2_ICPrevScale
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS3_P.DiscreteDerivative_ICPrevScal_a
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS3_P.DiscreteDerivative2_ICPrevSca_e
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS3_P.DiscreteDerivative_ICPrevSca_ay
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS3_P.DiscreteDerivative2_ICPrevSca_i
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS3_P.DiscreteDerivative_ICPrevScal_f
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS3_P.DiscreteDerivative1_ICPrevScale
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS3_P.DiscreteDerivative_ICPrevScal_e
                    section.data(9).logicalSrcIdx = 8;
                    section.data(9).dtTransOffset = 8;

                    ;% px4_noGPS3_P.DiscreteDerivative1_ICPrevSca_k
            ...
            section.data(158)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_P.Constant2_Value
                    section.data(1).logicalSrcIdx = 14;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_P.Constant3_Value
                    section.data(2).logicalSrcIdx = 15;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS3_P.Constant4_Value
                    section.data(3).logicalSrcIdx = 16;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS3_P.Constant2_Value_f
                    section.data(4).logicalSrcIdx = 17;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS3_P.Constant3_Value_j
                    section.data(5).logicalSrcIdx = 18;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS3_P.Constant4_Value_b
                    section.data(6).logicalSrcIdx = 19;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS3_P.Constant2_Value_i
                    section.data(7).logicalSrcIdx = 20;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS3_P.Constant3_Value_o
                    section.data(8).logicalSrcIdx = 21;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS3_P.Switch2_Threshold
                    section.data(9).logicalSrcIdx = 22;
                    section.data(9).dtTransOffset = 8;

                    ;% px4_noGPS3_P.Gain8_Gain
                    section.data(10).logicalSrcIdx = 23;
                    section.data(10).dtTransOffset = 9;

                    ;% px4_noGPS3_P.Constant_Value_l
                    section.data(11).logicalSrcIdx = 24;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS3_P.Gain5_Gain
                    section.data(12).logicalSrcIdx = 25;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS3_P.Gain6_Gain
                    section.data(13).logicalSrcIdx = 26;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS3_P.Gain4_Gain
                    section.data(14).logicalSrcIdx = 27;
                    section.data(14).dtTransOffset = 13;

                    ;% px4_noGPS3_P.Gain3_Gain
                    section.data(15).logicalSrcIdx = 28;
                    section.data(15).dtTransOffset = 14;

                    ;% px4_noGPS3_P.Gain2_Gain
                    section.data(16).logicalSrcIdx = 29;
                    section.data(16).dtTransOffset = 15;

                    ;% px4_noGPS3_P.Saturation_UpperSat
                    section.data(17).logicalSrcIdx = 30;
                    section.data(17).dtTransOffset = 16;

                    ;% px4_noGPS3_P.Saturation_LowerSat
                    section.data(18).logicalSrcIdx = 31;
                    section.data(18).dtTransOffset = 17;

                    ;% px4_noGPS3_P.Constant_Value_b
                    section.data(19).logicalSrcIdx = 32;
                    section.data(19).dtTransOffset = 18;

                    ;% px4_noGPS3_P.Constant_Value_p
                    section.data(20).logicalSrcIdx = 33;
                    section.data(20).dtTransOffset = 19;

                    ;% px4_noGPS3_P.Constant2_Value_o
                    section.data(21).logicalSrcIdx = 34;
                    section.data(21).dtTransOffset = 20;

                    ;% px4_noGPS3_P.Constant1_Value
                    section.data(22).logicalSrcIdx = 35;
                    section.data(22).dtTransOffset = 21;

                    ;% px4_noGPS3_P.Constant_Value_j
                    section.data(23).logicalSrcIdx = 36;
                    section.data(23).dtTransOffset = 22;

                    ;% px4_noGPS3_P.Constant2_Value_e
                    section.data(24).logicalSrcIdx = 37;
                    section.data(24).dtTransOffset = 23;

                    ;% px4_noGPS3_P.Constant1_Value_d
                    section.data(25).logicalSrcIdx = 38;
                    section.data(25).dtTransOffset = 24;

                    ;% px4_noGPS3_P.Constant_Value_e
                    section.data(26).logicalSrcIdx = 39;
                    section.data(26).dtTransOffset = 25;

                    ;% px4_noGPS3_P.Constant_Value_b1
                    section.data(27).logicalSrcIdx = 40;
                    section.data(27).dtTransOffset = 26;

                    ;% px4_noGPS3_P.DiscreteTimeIntegrator_gainval
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_P.Reset_Value
                    section.data(1).logicalSrcIdx = 172;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_P.attitude_flag_Value
                    section.data(2).logicalSrcIdx = 173;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS3_P.observer_flag_Value
                    section.data(3).logicalSrcIdx = 174;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS3_P.position_flag_Value
                    ...
                    ;% px4_noGPS3_P.DataStoreMemory_InitialValue_j
                    section.data(6).logicalSrcIdx = 177;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS3_P.DataStoreMemory1_InitialValue
                    section.data(7).logicalSrcIdx = 178;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS3_P.DataStoreMemory27_InitialValue
                    section.data(8).logicalSrcIdx = 179;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS3_P.DataStoreMemory30_InitialValue
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_P.ManualSwitch_CurrentSetting
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(35)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_B.DataStoreRead13
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS3_B.DataStoreRead15
                    section.data(5).logicalSrcIdx = 6;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS3_B.DataStoreRead16
                    section.data(6).logicalSrcIdx = 7;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS3_B.DataStoreRead17
                    section.data(7).logicalSrcIdx = 8;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS3_B.DataStoreRead19
                    ...
                    ;% px4_noGPS3_B.DataStoreRead25
                    section.data(10).logicalSrcIdx = 11;
                    section.data(10).dtTransOffset = 9;

                    ;% px4_noGPS3_B.DataStoreRead26
                    section.data(11).logicalSrcIdx = 12;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS3_B.DataStoreRead27
                    section.data(12).logicalSrcIdx = 13;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS3_B.pitch_thrust
                    section.data(13).logicalSrcIdx = 14;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS3_B.roll_thrust
                    section.data(14).logicalSrcIdx = 15;
                    section.data(14).dtTransOffset = 13;

                    ;% px4_noGPS3_B.yaw_thrust
                    section.data(15).logicalSrcIdx = 16;
                    section.data(15).dtTransOffset = 14;

                    ;% px4_noGPS3_B.tau_thrust
                    ...
                    ;% px4_noGPS3_B.DataStoreRead34
                    section.data(22).logicalSrcIdx = 23;
                    section.data(22).dtTransOffset = 21;

                    ;% px4_noGPS3_B.DataStoreRead35
                    section.data(23).logicalSrcIdx = 24;
                    section.data(23).dtTransOffset = 22;

                    ;% px4_noGPS3_B.DataStoreRead36
                    section.data(24).logicalSrcIdx = 25;
                    section.data(24).dtTransOffset = 23;

                    ;% px4_noGPS3_B.DataStoreRead37
                    section.data(25).logicalSrcIdx = 26;
                    section.data(25).dtTransOffset = 24;

                    ;% px4_noGPS3_B.DataStoreRead38
                    section.data(26).logicalSrcIdx = 27;
                    section.data(26).dtTransOffset = 25;

                    ;% px4_noGPS3_B.DataStoreRead39
                    section.data(27).logicalSrcIdx = 28;
                    section.data(27).dtTransOffset = 26;

                    ;% px4_noGPS3_B.DataStoreRead42
                    section.data(28).logicalSrcIdx = 29;
                    section.data(28).dtTransOffset = 27;

                    ;% px4_noGPS3_B.DataStoreRead43
                    section.data(29).logicalSrcIdx = 30;
                    section.data(29).dtTransOffset = 28;

                    ;% px4_noGPS3_B.DataStoreRead44
                    ...
                    ;% px4_noGPS3_B.DataStoreRead49
                    section.data(32).logicalSrcIdx = 33;
                    section.data(32).dtTransOffset = 31;

                    ;% px4_noGPS3_B.DataStoreRead55
                    section.data(33).logicalSrcIdx = 34;
                    section.data(33).dtTransOffset = 32;

                    ;% px4_noGPS3_B.DataStoreRead8
                    section.data(34).logicalSrcIdx = 35;
                    section.data(34).dtTransOffset = 33;

                    ;% px4_noGPS3_B.DataStoreRead9
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_DW.UD_DSTATE
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_DW.UD_DSTATE_j
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS3_DW.UD_DSTATE_d
                    section.data(3).logicalSrcIdx = 5;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS3_DW.UD_DSTATE_dv
                    ...
                    ;% px4_noGPS3_DW.UD_DSTATE_n
                    section.data(6).logicalSrcIdx = 8;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS3_DW.Intgrt_dX_DSTATE
                    section.data(7).logicalSrcIdx = 9;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS3_DW.Intgrt_dY_DSTATE
                    ...
                    ;% px4_noGPS3_DW.UD_DSTATE_g
                    section.data(11).logicalSrcIdx = 13;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS3_DW.UD_DSTATE_c
                    section.data(12).logicalSrcIdx = 14;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS3_DW.UD_DSTATE_n3
                    ...
                    ;% px4_noGPS3_DW.Intgrt_dZ_DSTATE
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_DW.Scope1_PWORK.LoggedData
                    section.data(1).logicalSrcIdx = 59;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_DW.Scope_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 60;
                    section.data(2).dtTransOffset = 4;

                    ;% px4_noGPS3_DW.Scope2_PWORK.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_DW.Subsystem1_SubsysRanBC
                    section.data(1).logicalSrcIdx = 62;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_DW.IfActionSubsystem2_SubsysRanBC
                    section.data(2).logicalSrcIdx = 63;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS3_DW.IfActionSubsystem1_SubsysRanBC
                    section.data(3).logicalSrcIdx = 64;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS3_DW.IfActionSubsystem_SubsysRanBC
                    section.data(4).logicalSrcIdx = 65;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS3_DW.EnabledSubsystem_SubsysRanBC
                    section.data(5).logicalSrcIdx = 66;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS3_DW.EnabledSubsystem_SubsysRanBC_b
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS3_DW.attitude_flag
                    section.data(1).logicalSrcIdx = 68;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS3_DW.position_flag
    ...
    targMap.checksum0 = 4073818490;
    targMap.checksum1 = 1781769308;
    targMap.checksum2 = 1311824966;
    targMap.checksum3 = 3125816610;
