...
P_px4_noGPS3_T px4_noGPS3_P = {
  ...
  // Computed Parameter: TSamp_WtEt_pq
  //  Referenced by: '<S28>/TSamp'

  200.0,

  // Expression: -11.82711478211336
