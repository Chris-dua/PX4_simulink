...
//
#ifndef RTW_HEADER_px4_noGPS3_h_
#define RTW_HEADER_px4_noGPS3_h_
#include <poll.h>
#include <uORB/uORB.h>
#include "rtwtypes.h"
...
struct DW_px4_noGPS3_T {
  ...
  real_T UD_DSTATE_d;                  // '<S16>/UD'
  real_T UD_DSTATE_dv;                 // '<S17>/UD'
  real_T UD_DSTATE_a;                  // '<S18>/UD'
...
struct P_px4_noGPS3_T_ {
  ...
  real_T DiscreteDerivative2_ICPrevSca_e;
                              // Mask Parameter: DiscreteDerivative2_ICPrevSca_e
                                 //  Referenced by: '<S17>/UD'

  real_T DiscreteDerivative_ICPrevSca_ay;
                              // Mask Parameter: DiscreteDerivative_ICPrevSca_ay
  ...
  real_T Constant_Value_l;             // Expression: 1.25
  ...
  real_T Gain3_Gain_g;                 // Expression: 50
                                          //  Referenced by: '<S13>/Gain3'

  real_T TSamp_WtEt_j;                 // Computed Parameter: TSamp_WtEt_j
                                          //  Referenced by: '<S16>/TSamp'

  real_T Gain2_Gain_c;                 // Expression: -40
                                          //  Referenced by: '<S13>/Gain2'

  real_T Gain4_Gain_n;                 // Expression: -50
                                          //  Referenced by: '<S13>/Gain4'

  real_T Gain5_Gain_i;                 // Expression: 0.2
                                          //  Referenced by: '<S13>/Gain5'

  real_T Gain6_Gain_j;                 // Expression: 0.012
  ...
  real_T Gain8_Gain_g;                 // Expression: -0.1
                                          //  Referenced by: '<S13>/Gain8'

  real_T Gain3_Gain_e;                 // Expression: 50
                                          //  Referenced by: '<S14>/Gain3'

  real_T TSamp_WtEt_e;                 // Computed Parameter: TSamp_WtEt_e
                                          //  Referenced by: '<S18>/TSamp'

  real_T Gain2_Gain_cm;                // Expression: -4.854809437386564
                                          //  Referenced by: '<S14>/Gain2'

  real_T Gain4_Gain_a;                 // Expression: -50
                                          //  Referenced by: '<S14>/Gain4'

  real_T Gain5_Gain_m;                 // Expression: 0.2
                                          //  Referenced by: '<S14>/Gain5'

  real_T Gain6_Gain_c;                 // Expression: 0.012
                                          //  Referenced by: '<S14>/Gain6'

  real_T Constant_Value_m;             // Expression: 1.25
  ...
  real_T Gain8_Gain_j;                 // Expression: -0.1
  ...
  real_T C1_Gain;                      // Expression: -12.09955218739235
                                          //  Referenced by: '<S24>/C1'

  real_T C3_Gain;                      // Expression: -5
                                          //  Referenced by: '<S24>/C3'

  real_T C4_Gain;                      // Expression: -12.09955218739235
  ...
  real_T Gain2_Gain_o;                 // Expression: 0.01
  ...
  real_T TSamp_WtEt_pq;                // Computed Parameter: TSamp_WtEt_pq
                                          //  Referenced by: '<S28>/TSamp'

  real_T C1_Gain_j;                    // Expression: -11.82711478211336
                                          //  Referenced by: '<S25>/C1'

  real_T k1_Gain;                      // Expression: -5
                                          //  Referenced by: '<S25>/k1'

  real_T C2_Gain;                      // Expression: -13.64995727712902
...
extern "C" {
  ...
  extern P_px4_noGPS3_T px4_noGPS3_P;
...
extern "C" {
  ...
  extern struct B_px4_noGPS3_T px4_noGPS3_B;
...
extern struct DW_px4_noGPS3_T px4_noGPS3_DW;
...
extern "C" {
  ...
  extern void px4_noGPS3_SetEventsForThisBaseStep(boolean_T *eventFlags);
...
extern "C" {
  ...
  extern void px4_noGPS3_SetEventsForThisBaseStep(boolean_T *eventFlags);
  extern void px4_noGPS3_initialize(void);
  extern void px4_noGPS3_step0(void);
  extern void px4_noGPS3_step1(void);
  extern void px4_noGPS3_step(int_T tid);
  extern void px4_noGPS3_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_px4_noGPS3_T *const px4_noGPS3_M;
...
//
//  '<Root>' : 'px4_noGPS3'
//  '<S1>'   : 'px4_noGPS3/Attitude controller'
//  '<S2>'   : 'px4_noGPS3/MATLAB Function1'
//  '<S3>'   : 'px4_noGPS3/MATLAB Function3'
//  '<S4>'   : 'px4_noGPS3/MATLAB Function5'
//  '<S5>'   : 'px4_noGPS3/PX4 uORB Read'
//  '<S6>'   : 'px4_noGPS3/PX4 uORB Read2'
//  '<S7>'   : 'px4_noGPS3/Position controller'
//  '<S8>'   : 'px4_noGPS3/Quaternions to Rotation Angles'
//  '<S9>'   : 'px4_noGPS3/Subsystem1'
//  '<S10>'  : 'px4_noGPS3/attitude_button'
//  '<S11>'  : 'px4_noGPS3/observer_button'
//  '<S12>'  : 'px4_noGPS3/position_button'
//  '<S13>'  : 'px4_noGPS3/Attitude controller/Subsystem'
//  '<S14>'  : 'px4_noGPS3/Attitude controller/Subsystem6'
//  '<S15>'  : 'px4_noGPS3/Attitude controller/Subsystem7'
//  '<S16>'  : 'px4_noGPS3/Attitude controller/Subsystem/Discrete Derivative'
//  '<S17>'  : 'px4_noGPS3/Attitude controller/Subsystem/Discrete Derivative2'
//  '<S18>'  : 'px4_noGPS3/Attitude controller/Subsystem6/Discrete Derivative'
//  '<S19>'  : 'px4_noGPS3/Attitude controller/Subsystem6/Discrete Derivative2'
//  '<S20>'  : 'px4_noGPS3/Attitude controller/Subsystem7/Discrete Derivative'
//  '<S21>'  : 'px4_noGPS3/Attitude controller/Subsystem7/Discrete Derivative2'
//  '<S22>'  : 'px4_noGPS3/PX4 uORB Read/Enabled Subsystem'
//  '<S23>'  : 'px4_noGPS3/PX4 uORB Read2/Enabled Subsystem'
//  '<S24>'  : 'px4_noGPS3/Position controller/Subsystem1'
//  '<S25>'  : 'px4_noGPS3/Position controller/Subsystem3'
//  '<S26>'  : 'px4_noGPS3/Position controller/Subsystem1/Discrete Derivative'
//  '<S27>'  : 'px4_noGPS3/Position controller/Subsystem1/Discrete Derivative1'
//  '<S28>'  : 'px4_noGPS3/Position controller/Subsystem3/Discrete Derivative'
//  '<S29>'  : 'px4_noGPS3/Position controller/Subsystem3/Discrete Derivative1'
//  '<S30>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Angle Calculation'
//  '<S31>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Quaternion Normalize'
//  '<S32>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input'
//  '<S33>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem'
//  '<S34>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem1'
//  '<S35>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem2'
//  '<S36>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus'
//  '<S37>'  : 'px4_noGPS3/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'

#endif                                 // RTW_HEADER_px4_noGPS3_h_
