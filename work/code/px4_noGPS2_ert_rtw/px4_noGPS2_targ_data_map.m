    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (px4_noGPS2_P)
        ;%
            section.nData     = 16;
            section.data(16)  = dumData; %prealloc

                    ;% px4_noGPS2_P.DiscreteDerivative1_ICPrevScale
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_P.DiscreteDerivative1_ICPrevSca_o
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_P.DiscreteDerivative1_ICPrevSca_d
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_P.DiscreteDerivative_ICPrevScaled
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS2_P.DiscreteDerivative1_ICPrevSc_dk
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS2_P.DiscreteDerivative_ICPrevScal_g
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS2_P.DiscreteDerivative1_ICPrevSca_c
                    ...
                    ;% px4_noGPS2_P.CompareToConstant2_const
                    ...
                    ;% px4_noGPS2_P.CompareToConstant2_const_o
                    ...
                    ;% px4_noGPS2_P.CompareToConstant2_const_a
            ...
            section.nData     = 334;
            section.data(334)  = dumData; %prealloc

                    ;% px4_noGPS2_P.Constant1_Value
                    section.data(1).logicalSrcIdx = 20;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_P.Constant1_Value_n
                    section.data(2).logicalSrcIdx = 21;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_P.Constant1_Value_a
                    section.data(3).logicalSrcIdx = 22;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_P.Saturation_UpperSat
                    section.data(4).logicalSrcIdx = 23;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS2_P.Saturation_LowerSat
                    section.data(5).logicalSrcIdx = 24;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS2_P.Constant_Value_b
                    section.data(6).logicalSrcIdx = 25;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS2_P.Constant3_Value
                    section.data(7).logicalSrcIdx = 26;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS2_P.Constant3_Value_a
                    section.data(8).logicalSrcIdx = 27;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS2_P.Constant3_Value_d
                    section.data(9).logicalSrcIdx = 28;
                    section.data(9).dtTransOffset = 8;

                    ;% px4_noGPS2_P.Constant_Value_h
                    section.data(10).logicalSrcIdx = 29;
                    section.data(10).dtTransOffset = 9;

                    ;% px4_noGPS2_P.Constant2_Value
                    section.data(11).logicalSrcIdx = 30;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS2_P.Constant1_Value_g
                    section.data(12).logicalSrcIdx = 31;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS2_P.Constant_Value_d
                    section.data(13).logicalSrcIdx = 32;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS2_P.Constant2_Value_i
                    section.data(14).logicalSrcIdx = 33;
                    section.data(14).dtTransOffset = 13;

                    ;% px4_noGPS2_P.Constant1_Value_nr
                    section.data(15).logicalSrcIdx = 34;
                    section.data(15).dtTransOffset = 14;

                    ;% px4_noGPS2_P.Constant_Value_e
                    section.data(16).logicalSrcIdx = 35;
                    section.data(16).dtTransOffset = 15;

                    ;% px4_noGPS2_P.Constant_Value_b1
                    section.data(17).logicalSrcIdx = 36;
                    section.data(17).dtTransOffset = 16;

                    ;% px4_noGPS2_P.DiscreteTimeIntegrator_gainval
                    ...
                    ;% px4_noGPS2_P.DiscreteTimeIntegrator3_gainv_e
                    ...
                    ;% px4_noGPS2_P.J_Gain_b
                    section.data(68).logicalSrcIdx = 87;
                    section.data(68).dtTransOffset = 67;

                    ;% px4_noGPS2_P.DataStoreMemory_InitialValue
                    section.data(69).logicalSrcIdx = 88;
                    section.data(69).dtTransOffset = 68;

                    ;% px4_noGPS2_P.DataStoreMemory_InitialValue_l
                    section.data(70).logicalSrcIdx = 89;
                    section.data(70).dtTransOffset = 69;

                    ;% px4_noGPS2_P.DataStoreMemory_InitialValue_b
                    ...
                    ;% px4_noGPS2_P.Saturation11_UpperSat_a
                    ...
                    ;% px4_noGPS2_P.Saturation9_UpperSat_d
                    ...
                    ;% px4_noGPS2_P.Saturation14_UpperSat_n
                    ...
                    ;% px4_noGPS2_P.Mixermatrix1_Value
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_P.Reset_Value
                    section.data(1).logicalSrcIdx = 354;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_P.attitude_flag_Value
                    section.data(2).logicalSrcIdx = 355;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_P.observer_flag_Value
                    section.data(3).logicalSrcIdx = 356;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_P.position_flag_Value
                    ...
                    ;% px4_noGPS2_P.DataStoreMemory_InitialValue_j
                    section.data(6).logicalSrcIdx = 359;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS2_P.DataStoreMemory1_InitialValue
                    section.data(7).logicalSrcIdx = 360;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS2_P.DataStoreMemory27_InitialValue
                    section.data(8).logicalSrcIdx = 361;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS2_P.DataStoreMemory30_InitialValue
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_P.ManualSwitch_CurrentSetting
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(46)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_B.DataStoreRead4
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_B.DataStoreRead4_g
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS2_B.DataStoreRead4_b
                    section.data(5).logicalSrcIdx = 6;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS2_B.rolldegree
                    section.data(6).logicalSrcIdx = 7;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS2_B.rolldegree_l
                    section.data(7).logicalSrcIdx = 8;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS2_B.rolldegree_c
                    section.data(8).logicalSrcIdx = 9;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS2_B.DataStore
                    ...
                    ;% px4_noGPS2_B.DataStoreRead13
                    section.data(12).logicalSrcIdx = 13;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS2_B.DataStoreRead15
                    section.data(13).logicalSrcIdx = 14;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS2_B.DataStoreRead16
                    section.data(14).logicalSrcIdx = 15;
                    section.data(14).dtTransOffset = 13;

                    ;% px4_noGPS2_B.DataStoreRead17
                    section.data(15).logicalSrcIdx = 16;
                    section.data(15).dtTransOffset = 14;

                    ;% px4_noGPS2_B.DataStoreRead19
                    ...
                    ;% px4_noGPS2_B.DataStoreRead25
                    section.data(18).logicalSrcIdx = 19;
                    section.data(18).dtTransOffset = 17;

                    ;% px4_noGPS2_B.DataStoreRead26
                    section.data(19).logicalSrcIdx = 20;
                    section.data(19).dtTransOffset = 18;

                    ;% px4_noGPS2_B.DataStoreRead27
                    section.data(20).logicalSrcIdx = 21;
                    section.data(20).dtTransOffset = 19;

                    ;% px4_noGPS2_B.pitch_thrust
                    section.data(21).logicalSrcIdx = 22;
                    section.data(21).dtTransOffset = 20;

                    ;% px4_noGPS2_B.roll_thrust
                    section.data(22).logicalSrcIdx = 23;
                    section.data(22).dtTransOffset = 21;

                    ;% px4_noGPS2_B.yaw_thrust
                    section.data(23).logicalSrcIdx = 24;
                    section.data(23).dtTransOffset = 22;

                    ;% px4_noGPS2_B.tau_thrust
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(48)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_DW.Intgrt_dX_DSTATE
                    section.data(13).logicalSrcIdx = 15;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS2_DW.Intgrt_dY_DSTATE
                    ...
                    ;% px4_noGPS2_DW.Intgrt_dZ_DSTATE
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_DW.Scope_PWORK.LoggedData
                    section.data(1).logicalSrcIdx = 65;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_DW.Scope_PWORK_o.LoggedData
                    section.data(2).logicalSrcIdx = 66;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_DW.Scope_PWORK_i.LoggedData
                    section.data(3).logicalSrcIdx = 67;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_DW.Scope_PWORK_ot.LoggedData
                    section.data(4).logicalSrcIdx = 68;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS2_DW.Scope_PWORK_f.LoggedData
                    section.data(5).logicalSrcIdx = 69;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS2_DW.Scope_PWORK_b.LoggedData
                    section.data(6).logicalSrcIdx = 70;
                    section.data(6).dtTransOffset = 6;

                    ;% px4_noGPS2_DW.Scope_PWORK_j.LoggedData
                    section.data(7).logicalSrcIdx = 71;
                    section.data(7).dtTransOffset = 7;

                    ;% px4_noGPS2_DW.Scope1_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 72;
                    section.data(8).dtTransOffset = 8;

                    ;% px4_noGPS2_DW.Scope_PWORK_m.LoggedData
                    section.data(9).logicalSrcIdx = 73;
                    section.data(9).dtTransOffset = 12;

                    ;% px4_noGPS2_DW.Scope2_PWORK.LoggedData
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_DW.Subsystem1_SubsysRanBC
                    section.data(1).logicalSrcIdx = 75;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_DW.IfActionSubsystem2_SubsysRanBC
                    section.data(2).logicalSrcIdx = 76;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_DW.IfActionSubsystem1_SubsysRanBC
                    section.data(3).logicalSrcIdx = 77;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS2_DW.IfActionSubsystem_SubsysRanBC
                    section.data(4).logicalSrcIdx = 78;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS2_DW.EnabledSubsystem_SubsysRanBC
                    section.data(5).logicalSrcIdx = 79;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS2_DW.EnabledSubsystem_SubsysRanBC_b
                    section.data(6).logicalSrcIdx = 80;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS2_DW.Subsystem_SubsysRanBC
                    section.data(7).logicalSrcIdx = 81;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS2_DW.Subsystem_SubsysRanBC_m
                    section.data(8).logicalSrcIdx = 82;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS2_DW.Subsystem_SubsysRanBC_k
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS2_DW.attitude_flag
                    section.data(1).logicalSrcIdx = 84;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS2_DW.position_flag
                    section.data(2).logicalSrcIdx = 86;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS2_DW.observer_flag
    ...
    targMap.checksum0 = 2306598611;
    targMap.checksum1 = 1253056208;
    targMap.checksum2 = 892141361;
    targMap.checksum3 = 56954483;
