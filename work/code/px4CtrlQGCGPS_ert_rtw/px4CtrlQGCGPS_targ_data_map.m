    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (px4CtrlQGCGPS_P)
        ;%
            section.nData     = 12;
            section.data(12)  = dumData; %prealloc

                    ;% px4CtrlQGCGPS_P.DiscreteDerivative1_ICPrevScale
                    ...
                    ;% px4CtrlQGCGPS_P.CompareToConstant2_const
                    ...
                    ;% px4CtrlQGCGPS_P.CompareToConstant2_const_o
                    ...
                    ;% px4CtrlQGCGPS_P.CompareToConstant2_const_a
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_P.Constant_Value
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_P.Constant_Value_c
            ...
            section.data(301)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation_UpperSat
                    section.data(4).logicalSrcIdx = 19;
                    section.data(4).dtTransOffset = 3;

                    ;% px4CtrlQGCGPS_P.Saturation_LowerSat
                    section.data(5).logicalSrcIdx = 20;
                    section.data(5).dtTransOffset = 4;

                    ;% px4CtrlQGCGPS_P.Constant_Value_b
                    ...
                    ;% px4CtrlQGCGPS_P.Constant_Value_e
                    section.data(10).logicalSrcIdx = 25;
                    section.data(10).dtTransOffset = 9;

                    ;% px4CtrlQGCGPS_P.Constant_Value_b1
                    ...
                    ;% px4CtrlQGCGPS_P.Constant5_Value
                    section.data(15).logicalSrcIdx = 30;
                    section.data(15).dtTransOffset = 14;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory22_InitialValue
                    section.data(16).logicalSrcIdx = 31;
                    section.data(16).dtTransOffset = 15;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory23_InitialValue
                    section.data(17).logicalSrcIdx = 32;
                    section.data(17).dtTransOffset = 16;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory24_InitialValue
                    section.data(18).logicalSrcIdx = 33;
                    section.data(18).dtTransOffset = 17;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory25_InitialValue
                    section.data(19).logicalSrcIdx = 34;
                    section.data(19).dtTransOffset = 18;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory26_InitialValue
                    section.data(20).logicalSrcIdx = 35;
                    section.data(20).dtTransOffset = 19;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory5_InitialValue
                    ...
                    ;% px4CtrlQGCGPS_P.b_Value
                    section.data(27).logicalSrcIdx = 42;
                    section.data(27).dtTransOffset = 26;

                    ;% px4CtrlQGCGPS_P.Gain4_Gain
                    ...
                    ;% px4CtrlQGCGPS_P.Gain1_Gain_o
                    section.data(35).logicalSrcIdx = 50;
                    section.data(35).dtTransOffset = 34;

                    ;% px4CtrlQGCGPS_P.Saturation4_UpperSat
                    section.data(36).logicalSrcIdx = 51;
                    section.data(36).dtTransOffset = 35;

                    ;% px4CtrlQGCGPS_P.Saturation4_LowerSat
                    section.data(37).logicalSrcIdx = 52;
                    section.data(37).dtTransOffset = 36;

                    ;% px4CtrlQGCGPS_P.SineWave_Amp
                    ...
                    ;% px4CtrlQGCGPS_P.DataStoreMemory_InitialValue_l
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation13_UpperSat
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation14_UpperSat
                    section.data(105).logicalSrcIdx = 120;
                    section.data(105).dtTransOffset = 104;

                    ;% px4CtrlQGCGPS_P.Saturation14_LowerSat
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation13_UpperSat_i
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation16_UpperSat_l
                    ...
                    ;% px4CtrlQGCGPS_P.Saturation14_UpperSat_l
                    section.data(161).logicalSrcIdx = 176;
                    section.data(161).dtTransOffset = 160;

                    ;% px4CtrlQGCGPS_P.Saturation14_LowerSat_b
                    ...
                    ;% px4CtrlQGCGPS_P.Constant2_Value_k
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_P.attitude_flag_Value
                    section.data(1).logicalSrcIdx = 317;
                    section.data(1).dtTransOffset = 0;

                    ;% px4CtrlQGCGPS_P.observer_flag_Value
                    section.data(2).logicalSrcIdx = 318;
                    section.data(2).dtTransOffset = 1;

                    ;% px4CtrlQGCGPS_P.position_flag_Value
                    ...
                    ;% px4CtrlQGCGPS_P.DataStoreMemory1_InitialValue
                    section.data(6).logicalSrcIdx = 322;
                    section.data(6).dtTransOffset = 5;

                    ;% px4CtrlQGCGPS_P.DataStoreMemory27_InitialValue
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_P.ManualSwitch_CurrentSetting
                    section.data(1).logicalSrcIdx = 325;
                    section.data(1).dtTransOffset = 0;

                    ;% px4CtrlQGCGPS_P.ManualSwitch_CurrentSetting_i
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(44)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_B.DataStoreRead4
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 2;

                    ;% px4CtrlQGCGPS_B.DataStoreRead4_g
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 3;

                    ;% px4CtrlQGCGPS_B.DataStoreRead4_b
                    section.data(5).logicalSrcIdx = 6;
                    section.data(5).dtTransOffset = 4;

                    ;% px4CtrlQGCGPS_B.rolldegree
                    section.data(6).logicalSrcIdx = 7;
                    section.data(6).dtTransOffset = 5;

                    ;% px4CtrlQGCGPS_B.rolldegree_l
                    section.data(7).logicalSrcIdx = 8;
                    section.data(7).dtTransOffset = 6;

                    ;% px4CtrlQGCGPS_B.rolldegree_c
                    ...
                    ;% px4CtrlQGCGPS_B.pitch_a
                    section.data(10).logicalSrcIdx = 11;
                    section.data(10).dtTransOffset = 9;

                    ;% px4CtrlQGCGPS_B.roll
                    section.data(11).logicalSrcIdx = 12;
                    section.data(11).dtTransOffset = 10;

                    ;% px4CtrlQGCGPS_B.pitch_g
                    ...
                    ;% px4CtrlQGCGPS_B.Gain5
                    section.data(14).logicalSrcIdx = 15;
                    section.data(14).dtTransOffset = 13;

                    ;% px4CtrlQGCGPS_B.Gain3
                    section.data(15).logicalSrcIdx = 16;
                    section.data(15).dtTransOffset = 14;

                    ;% px4CtrlQGCGPS_B.DataStoreRead13
                    section.data(16).logicalSrcIdx = 17;
                    section.data(16).dtTransOffset = 15;

                    ;% px4CtrlQGCGPS_B.DataStoreRead15
                    section.data(17).logicalSrcIdx = 18;
                    section.data(17).dtTransOffset = 16;

                    ;% px4CtrlQGCGPS_B.DataStoreRead16
                    section.data(18).logicalSrcIdx = 19;
                    section.data(18).dtTransOffset = 17;

                    ;% px4CtrlQGCGPS_B.DataStoreRead17
                    section.data(19).logicalSrcIdx = 20;
                    section.data(19).dtTransOffset = 18;

                    ;% px4CtrlQGCGPS_B.DataStoreRead19
                    section.data(20).logicalSrcIdx = 21;
                    section.data(20).dtTransOffset = 19;

                    ;% px4CtrlQGCGPS_B.Gain6
                    ...
                    ;% px4CtrlQGCGPS_B.DataStoreRead27
                    section.data(24).logicalSrcIdx = 25;
                    section.data(24).dtTransOffset = 23;

                    ;% px4CtrlQGCGPS_B.pitch_thrust
                    section.data(25).logicalSrcIdx = 26;
                    section.data(25).dtTransOffset = 24;

                    ;% px4CtrlQGCGPS_B.roll_thrust
                    ...
                    ;% px4CtrlQGCGPS_B.DataStoreRead34
                    section.data(28).logicalSrcIdx = 29;
                    section.data(28).dtTransOffset = 27;

                    ;% px4CtrlQGCGPS_B.DataStoreRead35
                    section.data(29).logicalSrcIdx = 30;
                    section.data(29).dtTransOffset = 28;

                    ;% px4CtrlQGCGPS_B.DataStoreRead36
                    section.data(30).logicalSrcIdx = 31;
                    section.data(30).dtTransOffset = 29;

                    ;% px4CtrlQGCGPS_B.DataStoreRead37
                    section.data(31).logicalSrcIdx = 32;
                    section.data(31).dtTransOffset = 30;

                    ;% px4CtrlQGCGPS_B.DataStoreRead38
                    section.data(32).logicalSrcIdx = 33;
                    section.data(32).dtTransOffset = 31;

                    ;% px4CtrlQGCGPS_B.DataStoreRead39
                    section.data(33).logicalSrcIdx = 34;
                    section.data(33).dtTransOffset = 32;

                    ;% px4CtrlQGCGPS_B.DataStoreRead42
                    section.data(34).logicalSrcIdx = 35;
                    section.data(34).dtTransOffset = 33;

                    ;% px4CtrlQGCGPS_B.DataStoreRead43
                    section.data(35).logicalSrcIdx = 36;
                    section.data(35).dtTransOffset = 34;

                    ;% px4CtrlQGCGPS_B.DataStoreRead44
                    section.data(36).logicalSrcIdx = 37;
                    section.data(36).dtTransOffset = 35;

                    ;% px4CtrlQGCGPS_B.DataStoreRead48
                    section.data(37).logicalSrcIdx = 38;
                    section.data(37).dtTransOffset = 36;

                    ;% px4CtrlQGCGPS_B.DataStoreRead49
                    section.data(38).logicalSrcIdx = 39;
                    section.data(38).dtTransOffset = 37;

                    ;% px4CtrlQGCGPS_B.DataStoreRead55
                    section.data(39).logicalSrcIdx = 40;
                    section.data(39).dtTransOffset = 38;

                    ;% px4CtrlQGCGPS_B.DataStoreRead8
                    section.data(40).logicalSrcIdx = 41;
                    section.data(40).dtTransOffset = 39;

                    ;% px4CtrlQGCGPS_B.DataStoreRead9
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_B.DataStoreRead12
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (px4CtrlQGCGPS_DW)
        ;%
            section.nData     = 1;
            section.data(1)  = dumData; %prealloc

                    ;% px4CtrlQGCGPS_DW.obj
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_DW.obj_n
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% px4CtrlQGCGPS_DW.obj_l
            ...
            section.data(40)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_DW.Intgrt_dX_DSTATE
                    section.data(13).logicalSrcIdx = 15;
                    section.data(13).dtTransOffset = 12;

                    ;% px4CtrlQGCGPS_DW.Intgrt_dY_DSTATE
                    ...
                    ;% px4CtrlQGCGPS_DW.Intgrt_dZ_DSTATE
                    ...
                    ;% px4CtrlQGCGPS_DW.lastSin
                    section.data(20).logicalSrcIdx = 28;
                    section.data(20).dtTransOffset = 19;

                    ;% px4CtrlQGCGPS_DW.lastCos
                    ...
                    ;% px4CtrlQGCGPS_DW.e_pitch
                    section.data(25).logicalSrcIdx = 33;
                    section.data(25).dtTransOffset = 24;

                    ;% px4CtrlQGCGPS_DW.e_pitch_roll
                    section.data(26).logicalSrcIdx = 34;
                    section.data(26).dtTransOffset = 25;

                    ;% px4CtrlQGCGPS_DW.e_pitch_yaw
                    ...
                    ;% px4CtrlQGCGPS_DW.pitch_acc
                    section.data(31).logicalSrcIdx = 45;
                    section.data(31).dtTransOffset = 30;

                    ;% px4CtrlQGCGPS_DW.roll_acc
                    section.data(32).logicalSrcIdx = 47;
                    section.data(32).dtTransOffset = 31;

                    ;% px4CtrlQGCGPS_DW.yaw_acc
                    section.data(33).logicalSrcIdx = 48;
                    section.data(33).dtTransOffset = 32;

                    ;% px4CtrlQGCGPS_DW.lat
                    section.data(34).logicalSrcIdx = 49;
                    section.data(34).dtTransOffset = 33;
                    ...
                    ;% px4CtrlQGCGPS_DW.lon
                    section.data(36).logicalSrcIdx = 52;
                    section.data(36).dtTransOffset = 35;

                    ;% px4CtrlQGCGPS_DW.alt
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_DW.Scope_PWORK.LoggedData
                    section.data(1).logicalSrcIdx = 59;
                    section.data(1).dtTransOffset = 0;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_o.LoggedData
                    section.data(2).logicalSrcIdx = 60;
                    section.data(2).dtTransOffset = 1;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_i.LoggedData
                    section.data(3).logicalSrcIdx = 61;
                    section.data(3).dtTransOffset = 2;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_ot.LoggedData
                    section.data(4).logicalSrcIdx = 62;
                    section.data(4).dtTransOffset = 3;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_f.LoggedData
                    section.data(5).logicalSrcIdx = 63;
                    section.data(5).dtTransOffset = 4;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_b.LoggedData
                    section.data(6).logicalSrcIdx = 64;
                    section.data(6).dtTransOffset = 6;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_j.LoggedData
                    section.data(7).logicalSrcIdx = 65;
                    section.data(7).dtTransOffset = 7;

                    ;% px4CtrlQGCGPS_DW.Scope_PWORK_m.LoggedData
                    section.data(8).logicalSrcIdx = 66;
                    section.data(8).dtTransOffset = 8;

                    ;% px4CtrlQGCGPS_DW.Scope1_PWORK.LoggedData
                    section.data(9).logicalSrcIdx = 67;
                    section.data(9).dtTransOffset = 11;

                    ;% px4CtrlQGCGPS_DW.Scope2_PWORK.LoggedData
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4CtrlQGCGPS_DW.Subsystem1_SubsysRanBC
                    ...
                    ;% px4CtrlQGCGPS_DW.Subsystem_SubsysRanBC
                    section.data(7).logicalSrcIdx = 76;
                    section.data(7).dtTransOffset = 6;

                    ;% px4CtrlQGCGPS_DW.Subsystem_SubsysRanBC_m
                    section.data(8).logicalSrcIdx = 77;
                    section.data(8).dtTransOffset = 7;

                    ;% px4CtrlQGCGPS_DW.Subsystem_SubsysRanBC_k
    ...
    targMap.checksum0 = 2661919328;
    targMap.checksum1 = 2081695294;
    targMap.checksum2 = 1665006267;
    targMap.checksum3 = 3051797346;
