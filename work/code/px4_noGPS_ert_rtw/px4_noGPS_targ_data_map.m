    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (px4_noGPS_P)
        ;%
            section.nData     = 14;
            section.data(14)  = dumData; %prealloc

                    ;% px4_noGPS_P.DiscreteDerivative1_ICPrevScale
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_P.DiscreteDerivative1_ICPrevSca_o
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_P.DiscreteDerivative1_ICPrevSca_d
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS_P.DiscreteDerivative_ICPrevScaled
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS_P.DiscreteDerivative_ICPrevScal_g
                    ...
                    ;% px4_noGPS_P.CompareToConstant2_const
                    ...
                    ;% px4_noGPS_P.CompareToConstant2_const_o
                    ...
                    ;% px4_noGPS_P.CompareToConstant2_const_a
            ...
            section.nData     = 319;
            section.data(319)  = dumData; %prealloc

                    ;% px4_noGPS_P.Constant1_Value
                    section.data(1).logicalSrcIdx = 18;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_P.Constant1_Value_n
                    section.data(2).logicalSrcIdx = 19;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_P.Constant1_Value_a
                    section.data(3).logicalSrcIdx = 20;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS_P.Saturation_UpperSat
                    section.data(4).logicalSrcIdx = 21;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS_P.Saturation_LowerSat
                    section.data(5).logicalSrcIdx = 22;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS_P.Constant_Value_b
                    section.data(6).logicalSrcIdx = 23;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS_P.Constant3_Value
                    section.data(7).logicalSrcIdx = 24;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS_P.Constant3_Value_a
                    section.data(8).logicalSrcIdx = 25;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS_P.Constant3_Value_d
                    section.data(9).logicalSrcIdx = 26;
                    section.data(9).dtTransOffset = 8;

                    ;% px4_noGPS_P.Constant1_Value_g
                    section.data(10).logicalSrcIdx = 27;
                    section.data(10).dtTransOffset = 9;

                    ;% px4_noGPS_P.Constant1_Value_nr
                    section.data(11).logicalSrcIdx = 28;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS_P.Constant_Value_e
                    section.data(12).logicalSrcIdx = 29;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS_P.Constant_Value_b1
                    section.data(13).logicalSrcIdx = 30;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS_P.DiscreteTimeIntegrator_gainval
                    ...
                    ;% px4_noGPS_P.Constant9_Value
                    section.data(16).logicalSrcIdx = 33;
                    section.data(16).dtTransOffset = 15;

                    ;% px4_noGPS_P.Constant5_Value
                    section.data(17).logicalSrcIdx = 34;
                    section.data(17).dtTransOffset = 16;

                    ;% px4_noGPS_P.Constant7_Value
                    section.data(18).logicalSrcIdx = 35;
                    section.data(18).dtTransOffset = 17;

                    ;% px4_noGPS_P.Constant8_Value
                    section.data(19).logicalSrcIdx = 36;
                    section.data(19).dtTransOffset = 18;

                    ;% px4_noGPS_P.DataStoreMemory33_InitialValue
                    section.data(20).logicalSrcIdx = 37;
                    section.data(20).dtTransOffset = 19;

                    ;% px4_noGPS_P.DataStoreMemory34_InitialValue
                    section.data(21).logicalSrcIdx = 38;
                    section.data(21).dtTransOffset = 20;

                    ;% px4_noGPS_P.DataStoreMemory35_InitialValue
                    section.data(22).logicalSrcIdx = 39;
                    section.data(22).dtTransOffset = 21;

                    ;% px4_noGPS_P.DataStoreMemory5_InitialValue
                    ...
                    ;% px4_noGPS_P.Gain4_Gain
                    section.data(29).logicalSrcIdx = 46;
                    section.data(29).dtTransOffset = 28;

                    ;% px4_noGPS_P.TSamp_WtEt
                    ...
                    ;% px4_noGPS_P.Gain_Gain
                    section.data(32).logicalSrcIdx = 49;
                    section.data(32).dtTransOffset = 31;

                    ;% px4_noGPS_P.Gain1_Gain
                    ...
                    ;% px4_noGPS_P.J_Gain_b
                    section.data(64).logicalSrcIdx = 81;
                    section.data(64).dtTransOffset = 63;

                    ;% px4_noGPS_P.DataStoreMemory_InitialValue
                    section.data(65).logicalSrcIdx = 82;
                    section.data(65).dtTransOffset = 64;

                    ;% px4_noGPS_P.DataStoreMemory_InitialValue_l
                    section.data(66).logicalSrcIdx = 83;
                    section.data(66).dtTransOffset = 65;

                    ;% px4_noGPS_P.DataStoreMemory_InitialValue_b
                    ...
                    ;% px4_noGPS_P.Saturation_UpperSat_b
                    section.data(73).logicalSrcIdx = 90;
                    section.data(73).dtTransOffset = 72;

                    ;% px4_noGPS_P.Saturation_LowerSat_k
                    ...
                    ;% px4_noGPS_P.lambda1_Gain
                    section.data(76).logicalSrcIdx = 93;
                    section.data(76).dtTransOffset = 75;

                    ;% px4_noGPS_P.DiscreteTimeIntegrator1_gainval
                    ...
                    ;% px4_noGPS_P.Constant1_Value_f
                    section.data(79).logicalSrcIdx = 96;
                    section.data(79).dtTransOffset = 78;

                    ;% px4_noGPS_P.Saturation10_UpperSat
                    section.data(80).logicalSrcIdx = 97;
                    section.data(80).dtTransOffset = 79;

                    ;% px4_noGPS_P.Saturation10_LowerSat
                    section.data(81).logicalSrcIdx = 98;
                    section.data(81).dtTransOffset = 80;

                    ;% px4_noGPS_P.Saturation11_UpperSat
                    section.data(82).logicalSrcIdx = 99;
                    section.data(82).dtTransOffset = 81;

                    ;% px4_noGPS_P.Saturation11_LowerSat
                    ...
                    ;% px4_noGPS_P.Saturation8_UpperSat_c
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_P.attitude_flag_Value
                    section.data(1).logicalSrcIdx = 337;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_P.observer_flag_Value
                    section.data(2).logicalSrcIdx = 338;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_P.position_flag_Value
                    ...
                    ;% px4_noGPS_P.Reset_Value
                    section.data(5).logicalSrcIdx = 341;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS_P.DataStoreMemory_InitialValue_j
                    section.data(6).logicalSrcIdx = 342;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS_P.DataStoreMemory1_InitialValue
                    section.data(7).logicalSrcIdx = 343;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS_P.DataStoreMemory27_InitialValue
                    section.data(8).logicalSrcIdx = 344;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS_P.DataStoreMemory30_InitialValue
                    section.data(9).logicalSrcIdx = 345;
                    section.data(9).dtTransOffset = 8;
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_P.ManualSwitch_CurrentSetting
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(45)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_B.DataStoreRead4
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS_B.DataStoreRead4_g
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS_B.DataStoreRead4_b
                    section.data(5).logicalSrcIdx = 6;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS_B.rolldegree
                    section.data(6).logicalSrcIdx = 7;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS_B.rolldegree_l
                    section.data(7).logicalSrcIdx = 8;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS_B.rolldegree_c
                    ...
                    ;% px4_noGPS_B.DataStoreRead13
                    section.data(11).logicalSrcIdx = 12;
                    section.data(11).dtTransOffset = 10;

                    ;% px4_noGPS_B.DataStoreRead15
                    section.data(12).logicalSrcIdx = 13;
                    section.data(12).dtTransOffset = 11;

                    ;% px4_noGPS_B.DataStoreRead16
                    section.data(13).logicalSrcIdx = 14;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS_B.DataStoreRead17
                    section.data(14).logicalSrcIdx = 15;
                    section.data(14).dtTransOffset = 13;

                    ;% px4_noGPS_B.DataStoreRead19
                    ...
                    ;% px4_noGPS_B.DataStoreRead27
                    section.data(19).logicalSrcIdx = 20;
                    section.data(19).dtTransOffset = 18;

                    ;% px4_noGPS_B.pitch_thrust
                    section.data(20).logicalSrcIdx = 21;
                    section.data(20).dtTransOffset = 19;

                    ;% px4_noGPS_B.roll_thrust
                    section.data(21).logicalSrcIdx = 22;
                    section.data(21).dtTransOffset = 20;

                    ;% px4_noGPS_B.yaw_thrust
                    section.data(22).logicalSrcIdx = 23;
                    section.data(22).dtTransOffset = 21;

                    ;% px4_noGPS_B.DataStoreRead73
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(47)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_DW.Intgrt_dX_DSTATE
                    section.data(13).logicalSrcIdx = 15;
                    section.data(13).dtTransOffset = 12;

                    ;% px4_noGPS_DW.Intgrt_dY_DSTATE
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_DW.Scope_PWORK.LoggedData
                    section.data(1).logicalSrcIdx = 64;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_DW.Scope_PWORK_o.LoggedData
                    section.data(2).logicalSrcIdx = 65;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_DW.Scope_PWORK_i.LoggedData
                    section.data(3).logicalSrcIdx = 66;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS_DW.Scope_PWORK_ot.LoggedData
                    section.data(4).logicalSrcIdx = 67;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS_DW.Scope_PWORK_f.LoggedData
                    section.data(5).logicalSrcIdx = 68;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS_DW.Scope_PWORK_b.LoggedData
                    section.data(6).logicalSrcIdx = 69;
                    section.data(6).dtTransOffset = 6;

                    ;% px4_noGPS_DW.Scope_PWORK_j.LoggedData
                    section.data(7).logicalSrcIdx = 70;
                    section.data(7).dtTransOffset = 7;

                    ;% px4_noGPS_DW.Scope1_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 71;
                    section.data(8).dtTransOffset = 8;

                    ;% px4_noGPS_DW.Scope_PWORK_m.LoggedData
                    section.data(9).logicalSrcIdx = 72;
                    section.data(9).dtTransOffset = 12;

                    ;% px4_noGPS_DW.Scope2_PWORK.LoggedData
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_DW.Subsystem1_SubsysRanBC
                    section.data(1).logicalSrcIdx = 74;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_DW.IfActionSubsystem2_SubsysRanBC
                    section.data(2).logicalSrcIdx = 75;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_DW.IfActionSubsystem1_SubsysRanBC
                    section.data(3).logicalSrcIdx = 76;
                    section.data(3).dtTransOffset = 2;

                    ;% px4_noGPS_DW.IfActionSubsystem_SubsysRanBC
                    section.data(4).logicalSrcIdx = 77;
                    section.data(4).dtTransOffset = 3;

                    ;% px4_noGPS_DW.EnabledSubsystem_SubsysRanBC
                    section.data(5).logicalSrcIdx = 78;
                    section.data(5).dtTransOffset = 4;

                    ;% px4_noGPS_DW.EnabledSubsystem_SubsysRanBC_b
                    section.data(6).logicalSrcIdx = 79;
                    section.data(6).dtTransOffset = 5;

                    ;% px4_noGPS_DW.Subsystem_SubsysRanBC
                    section.data(7).logicalSrcIdx = 80;
                    section.data(7).dtTransOffset = 6;

                    ;% px4_noGPS_DW.Subsystem_SubsysRanBC_m
                    section.data(8).logicalSrcIdx = 81;
                    section.data(8).dtTransOffset = 7;

                    ;% px4_noGPS_DW.Subsystem_SubsysRanBC_k
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% px4_noGPS_DW.attitude_flag
                    section.data(1).logicalSrcIdx = 83;
                    section.data(1).dtTransOffset = 0;

                    ;% px4_noGPS_DW.position_flag
                    section.data(2).logicalSrcIdx = 85;
                    section.data(2).dtTransOffset = 1;

                    ;% px4_noGPS_DW.observer_flag
    ...
    targMap.checksum0 = 1063988621;
    targMap.checksum1 = 2154102270;
    targMap.checksum2 = 1309426222;
    targMap.checksum3 = 4192412788;
